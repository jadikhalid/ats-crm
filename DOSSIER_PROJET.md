...
*Document généré pour le projet **ESN ATS/CRM** — dépôt `ats-crm`.  
Références techniques complémentaires : [`README.md`](README.md), [`architecture_plan.md`](architecture_plan.md).*
