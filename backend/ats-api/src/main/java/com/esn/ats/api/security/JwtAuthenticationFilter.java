...
import com.esn.ats.infrastructure.security.DomainUserDetailsService;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        if (authHeader != null && authHeader.startsWith("Bearer ")) {
            ...
            if (jwtTokenPort.validateToken(token) && SecurityContextHolder.getContext().getAuthentication() == null) {
